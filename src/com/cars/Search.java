...
public class Search extends Activity implements OnClickListener,
	...
	Spinner spinModel = null;
	Button btnReset, btnSearch;
	
	List<String> brandLabels, modelLabels;
...

	{
		...
		entry = new DBHelper(Search.this);
		entry.openForRead();
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		case R.id.spinBrand:
			...
			CarData.SPIN_BRAND = s;
			selectSpinner(s);
			break;
		case R.id.spinModel:
			CarData.SPIN_MODEL = arg0.getSelectedItem().toString();
			break;
		}
